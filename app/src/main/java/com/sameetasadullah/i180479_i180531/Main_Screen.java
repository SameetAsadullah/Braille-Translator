...
//        writerAndReader writerAndReader = new writerAndReader(Main_Screen.this);

//        Hotel hotel = new Hotel(1, "abc", "abc", "abc", "5", "5", "abc", "abc");
//        writerAndReader.readRoomsFromServer(hotel);
//        System.out.println(hotel.getRooms().size());
//        writerAndReader.truncateATable("rooms");
    }
}